...
// -----------------------------------------------------------------
#define CDL_V_TRA_MAX   1410.0	// mm/s
#define CDL_V_TRA_MIN  -1410.0	// mm/s
#define CDL_V_TRA_MAX_STANDARD   1000.0	// mm/s
#define CDL_V_TRA_MIN_STANDARD  -1000.0	// mm/s
#define CDL_V_ROT_MAX   70.0  	// deg/s
#define CDL_V_ROT_MIN  -70.0	// deg/s

#define CDL_V_TRA_STEP  10.0  	// mm/s
#define CDL_V_TRA_STEP_COARSE_80 100.0
#define CDL_V_TRA_STEP_COARSE_400 20.0
#define CDL_V_ROT_STEP  1.0	// deg/s

// some robot specific parameters
#define CDL_A_ROT_MAX    30.0    // deg/s2 //(100)
#define CDL_A_TRA_MAX   300.0   // mm/s2 //(500)

#define CDL_TRA_CELLS ((CDL_V_TRA_MAX-CDL_V_TRA_MIN)/CDL_V_TRA_STEP+1)
#define CDL_TRA_CELLS_COARSE_80 ((CDL_V_TRA_MAX_STANDARD-CDL_V_TRA_MIN_STANDARD)/CDL_V_TRA_STEP_COARSE_80+1)
#define CDL_TRA_CELLS_COARSE_400 ((CDL_V_TRA_MAX_STANDARD-CDL_V_TRA_MIN_STANDARD)/CDL_V_TRA_STEP_COARSE_400+1)
#define CDL_TRA_CELLS_CLASSIC ((CDL_V_TRA_MAX_STANDARD-CDL_V_TRA_MIN_STANDARD)/CDL_V_TRA_STEP+1)
...
// In Online part = -2500.0
#define CDL_C_X_MIN	   -500.0
...
#define CDL_CURVATURE_INDICES_STRAIGHT	(CDL_TRA_CELLS*2+CDL_TRA_CELLS*2-4)
...
const int numberOfOuterCellsHeader = 2156 + 680;
#define CDL_MAX_CURVATURE_STRAIGHT 800

#define CURVATURE_INDICES_RADIUS 423

#define CURVATURE_INDICES_ICC_COARSE 400
